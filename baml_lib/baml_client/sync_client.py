...
class BamlSyncClient:
    ...
    def ExtractYugiohCardFromImage(self, img: baml_py.Image,
        ...
        if 'on_tick' in baml_options:
            ...
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractYugiohCardFromImage", args={
                "img": img,
            })
...
class BamlStreamClient:
    ...
    def ExtractYugiohCardFromImage(self, img: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.YugiohCard, types.YugiohCard]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractYugiohCardFromImage", args={
            "img": img,
        })
        return baml_py.BamlSyncStream[stream_types.YugiohCard, types.YugiohCard](
          result,
...
class BamlHttpRequestClient:
    ...
    def ExtractYugiohCardFromImage(self, img: baml_py.Image,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractYugiohCardFromImage", args={
            "img": img,
        }, mode="request")
        return result
